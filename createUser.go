...
func createUserAll(execConfig *ExecutorConfig, threads *int, okClient *OktaClient) {
...
func createUser(User []string, okClient *OktaClient, execConfig *ExecutorConfig, firstRow *[]string) (jobStatus bool) {
